...
class TestOCIMode extends TestCase
{

    public function test__construct()
    {
        $oci = new OCIMode("OT", "Orcl123456", "127.0.0.1/gmtest", 'UTF8');
    ...
    {
        $oci1 = new OCIMode("OT", "Orcl123456", "127.0.0.1/gmtest", 'UTF8');
        $oci1->startTrans();
        $sql = "INSERT INTO BIND_EXAMPLE VALUES(:text)";
        ...
        $oci2 = new OCIMode("OT", "Orcl123456", "127.0.0.1/gmtest", 'UTF8');
        $oci2->startTrans();
        $sql = "INSERT INTO BIND_EXAMPLE VALUES(:text)";
